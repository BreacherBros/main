...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function startGame(clsName){
    ...
    initScene();        // Szene erzeugt Kamera
    initPointerLock();  // Danach erst PointerLock
    initPlayer();
    animate();
  }
  ...
  function initPlayer(){
    ...
    player.mesh = new THREE.Mesh(new THREE.BoxGeometry(1,2,1),
  ...
  function updateHUD(){
    ...
    ammoEl.innerText = player.weapon?.reloading ? "Nachladen..." :
